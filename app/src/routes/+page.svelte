<script lang="ts">
    ...
    import { thighquatL, thighquatR, baseBoneQuat } from "../stores/store";
    import { animateModel, add_rigged_model } from "$lib/RiggedModel";
    import { createTextTexture } from "$lib/GenerateTextureFromText";
    ...
    onMount(() => {
        ...
        const render = function () {
            ...
            if (counter > 300) {
                ...
                animateModel( controller1.position, controller2.position, rot,  _thighquatL, _thighquatR, _baseBoneQuat, hmdCamera.position);
            }
            counter += 1;
        };
