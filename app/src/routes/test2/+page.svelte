<script lang="ts">
    ...
    import { animateModel, add_rigged_model } from "$lib/RiggedModel";
    import {connectToWebSocket, thighquatL, thighquatR, baseBoneQuat } from "../../stores/store";
    ...
    function init() {
        ...
        transformControlsRotation3.attach(greenCube);
    ...
    function render() {
        ...
        // greenCube.setRotationFromQuaternion(quat_test2);
        // animateModel(
        //     cubeR.position,
        //     cubeL.position,
        //     cubeRot.rotation,
        ...
        //     baseBoneQuat,
        // );
        // animateModel(positionL, positionR, headRotation, thighquatL, thighquatR, baseBoneQuat, baseBonePosition)
        const baseBonePosition = new THREE.Vector3(0, 1, 0);
        const _thighquatL = new THREE.Quaternion(1, 0, 0, 0);
        const _thighquatR = new THREE.Quaternion(1, 0, 0, 0);
        animateModel(cubeR.position, cubeL.position, greenCube.rotation, _thighquatL, _thighquatR, cubeRot.quaternion, cubeL.position);
    }
</script>
